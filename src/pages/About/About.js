          ...
          <div
            ...
            <div className="border p-6 rounded-lg linear-bg text-center">
              <ScrollTrigger onEnter={() => setCountOn(true)} onExit={() => setCountOn(false)}>
                <div>
                  <h1 className="text-3xl">{countOn && <CountUp start={0} end={100} duration={2} delay={0}></CountUp>}%
                  <br /> <span className="text-lg capitalize">Success Rate</span>
                  </h1>
                </div>
              </ScrollTrigger>
            </div>
            <div className="border p-6 rounded-lg linear-bg text-center">
              <ScrollTrigger onEnter={() => setCountOn(true)} onExit={() => setCountOn(false)}>
                <div>
                  <h1 className="text-3xl">{countOn && <CountUp start={0} end={1000} duration={2} delay={0}></CountUp>}
                  + <br /> <span className="text-lg capitalize">Hours of work</span>
                  </h1>
                </div>
              </ScrollTrigger>
            </div>
            <div className="border p-6 rounded-lg linear-bg text-center">
              <ScrollTrigger onEnter={() => setCountOn(true)} onExit={() => setCountOn(false)}>
                <div>
                  <h1 className="text-3xl">{countOn && <CountUp start={0} end={350} duration={2} delay={0}></CountUp>}
                  + <br /> <span className="text-lg capitalize">Happy Clients</span>
                  </h1>
                </div>
              </ScrollTrigger>
            </div>
